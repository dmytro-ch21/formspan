...
// logs, not secrets, so there's no need for a CSPRNG or a polyfill.
//
// Duplicated in apps/mobile rather than shared — a ~15-line utility isn't
...
/** A fresh 32-hex-char trace ID — generate once per page view and reuse across every request it makes. */
