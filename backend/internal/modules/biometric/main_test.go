...
// delete them again on the way out — the same shape running/bjj's tests
// take, for the same reason: a second copy of this binary running against
// the same shared database is the ordinary state of this repo, not a rare
// one. The lock makes this binary the sole writer of its database for as
// long as it runs. See internal/platform/testdb for the mechanism.
//
