...
/**
 * The one control that makes a technique visible to athletes.
 *
 ...
 * half-written technique — the exact thing drafts exist to prevent. Its own
 * form, its own action, its own endpoint, all the way down.
 *
    ...
    <form action={formAction} className="flex flex-col gap-2">
      <div className="flex items-center gap-3">
        ...
        <span className="text-[13px] text-text-secondary">
          Makes it visible in the athlete library. There is no unpublish — see the note.
        </span>
      </div>
