...
- Structured logging + request/trace IDs exist in the API (`backend/internal/platform/httplog`), but no frontend app propagates a `traceparent` yet — every request today starts a fresh trace.
