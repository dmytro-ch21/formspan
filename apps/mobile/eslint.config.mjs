 ...
 * (N572: Today, N573: Food, N574: Progress, N575: Plan, N576: You, N577: Session). An ALLOWLIST, not a directory
...
const N508_CONVERTED_FILES = [
  ...
  // N574 (#1189) — Progress; `app/(tabs)/progress.tsx` is N508's, above.
  "components/progress/Reading.tsx",
  "components/progress/ThisWeek.tsx",
  "components/progress/TrainingHistory.tsx",
  "components/progress/WhatChanged.tsx",
  // N575 (#1190) — Plan; `app/(tabs)/workouts.tsx` is N508's, above.
  "components/CurriculaStrip.tsx",
  "components/PlanHero.tsx",
  "components/WeekPlanner.tsx",
  // N576 (#1191) — You, and the two components only it imports.
  "app/(tabs)/you.tsx",
  "components/BjjRankHeader.tsx",
  "components/RoadmapSummary.tsx",
