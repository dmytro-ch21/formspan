...
const styles = StyleSheet.create({
  ...
  scopeTabActive: { backgroundColor: '#0B1220', borderColor: '#0B1220' },
  scopeText: { fontWeight: '600' },
  scopeTextActive: { color: '#B8FF2C' },
  loader: { marginTop: 32 },
  ...
  cardMeta: { fontSize: 13, color: '#6b7280', textTransform: 'capitalize' },
  badge: {
    fontSize: 11,
    fontWeight: '700',
    color: '#5c6b00',
  ...
  fabText: { color: '#B8FF2C', fontWeight: '700', fontSize: 16 },

  sheet: { flex: 1, padding: 20, gap: 12 },
  sheetHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  sheetTitle: { fontSize: 17, fontWeight: '700' },
  link: { fontSize: 16, color: '#0B1220', fontWeight: '600' },
  ...
  switchOn: { backgroundColor: '#0B1220' },
  knob: { width: 24, height: 24, borderRadius: 999, backgroundColor: '#fff' },
  knobOn: { alignSelf: 'flex-end', backgroundColor: '#B8FF2C' },
});
