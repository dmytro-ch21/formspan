...
const styles = StyleSheet.create({
  ...
  title: { ...Typography.eyebrow, color: vola.text },
  pill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: Spacing.xsPlus,
  ...
  pillLabel: { ...Typography.caption, color: vola.textMuted, fontWeight: '400' },

  body: { flexDirection: 'row', alignItems: 'center', gap: Spacing.cardPadding },
  ringColumn: { alignItems: 'center', gap: Spacing.xs },
  rows: { flex: 1, gap: Spacing.md },
  absent: { ...Typography.meta, color: vola.textDim },
  ...
  // 30, not `display`: the hero figure on the ring plate, with leading set for it.
  centreBig: {
    fontSize: 30,
    fontWeight: '800',
    color: vola.text,
  ...
  // 11 is the scale's floor, not a role: one word under the figure on the ring plate.
  centreUnit: { fontSize: Typography.eyebrow.fontSize, color: vola.textMuted },
  centreMeta: {
    ...Typography.caption,
    color: vola.textDim,
    fontVariant: ['tabular-nums'],
  ...
  centreAbsent: { ...Typography.body, color: vola.textDim },
  entries: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xs, marginTop: Spacing.xxs },
  entriesLabel: { ...Typography.caption, color: vola.textDim, fontWeight: '400' },

  row: { gap: 3 },
  rowHead: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xsPlus },
  ...
  rowGoal: { ...Typography.meta, color: vola.textDim, fontWeight: '500' },
  rowPct: { ...Typography.caption, fontVariant: ['tabular-nums'] },
  ...
  chipLabel: { ...Typography.caption, color: vola.textMuted, fontWeight: '400' },
  primary: {
  ...
  primaryLabel: { ...Typography.body, color: vola.bg, fontWeight: '700' },
  configure: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  configureLabel: { ...Typography.caption, color: vola.textMuted, fontWeight: '400' },
  openDay: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  openDayLabel: { ...Typography.caption, color: vola.textMuted, fontWeight: '400' },
});
