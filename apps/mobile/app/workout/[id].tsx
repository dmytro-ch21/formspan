...
const styles = StyleSheet.create({
  ...
  meta: { color: '#6b7280', fontSize: 13, textTransform: 'capitalize' },
  readonly: {
    fontSize: 13,
    color: '#5c6b00',
    backgroundColor: '#f4ffd6',
    padding: 10,
    borderRadius: 10,
    overflow: 'hidden',
  },
  headerAction: { fontSize: 16, fontWeight: '600', color: '#0B1220' },
  item: { borderWidth: 1, borderColor: '#e4e4df', borderRadius: 14, backgroundColor: '#fff' },
  itemHead: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12 },
  itemIndex: { width: 18, textAlign: 'center', color: '#9aa0a6', fontWeight: '700' },
  thumb: { width: 52, height: 52, borderRadius: 10, backgroundColor: '#eceff3' },
  thumbEmpty: {},
  itemBody: { flex: 1, gap: 2 },
  itemName: { fontSize: 15, fontWeight: '600' },
  disclosure: { color: '#9aa0a6', fontSize: 16, width: 18, textAlign: 'center' },
  ...
  deleteText: { color: '#d1591a', fontWeight: '600' },
