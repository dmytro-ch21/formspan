...
func writeError(w http.ResponseWriter, r *http.Request, err error) {
	...
	case errors.Is(err, ErrInvalidInput):
		...
		// renders a picker over exactly these values, so a rejection here
		// means the two have drifted and the message should say how.
		apihttp.WriteError(w, http.StatusBadRequest, apihttp.CodeInvalidInput,
			"belt must be one of white, blue, purple, brown, black; stripes 0-4; degree 0-6 and only on black")
	default:
