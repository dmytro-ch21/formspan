...
cd backend && go run ./cmd/exportcontent    # carry console-authored content into BOTH techniques.json (the deploy artifact) and techniques.additions.json (the importer's record) — one without the other is lost
